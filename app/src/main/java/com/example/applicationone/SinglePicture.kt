 ...
 * [SinglePicture.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [SinglePicture.newInstance] factory method to
...
class SinglePicture : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SinglePicture.
         */
